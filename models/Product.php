...
class Product extends \yii\db\ActiveRecord
{
  ...
  public function rules()
  {
    return [
      ...
      [["price", "discount_price", "average_rating", "total_ratings"], "number"],
  ...
  {
    return $this->discount_price ? (($this->discount_price) / $this->price) * 100 : 0;
  }
  ...
  {
    return ArrayHelper::map(Product::find()->select(['created_by_id', 'id'])->all(), 'id', function ($model) {
      return (string)$model;
    });
  }
  ...
  {
    return $this->getProductTranslationForLanguage() ? $this->getProductTranslationForLanguage()->title : $this->createdBy->username . ' -> ' . $this->id;
  }
}
