...
echo Nav::widget([ // Use Nav widget for the navigation items
        'options' => ['class' => 'nav flex-column nav-pills'], // Adjust classes for vertical layout
        'items' => [
            ['label' => 'Products', 'url' => ['product/index']],
            ['label' => 'Product Translations', 'url' => ['product-translation/index']],
            ['label' => 'Users', 'url' => ['user/index']],
            ['label' => 'Categories', 'url' => ['category/index']],
            ['label' => 'Category Translations', 'url' => ['category-translation/index']],
