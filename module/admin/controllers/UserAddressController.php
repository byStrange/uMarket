...
class UserAddressController extends Controller
{
   ...
   */
  public function actionCreate($popup = "", $d = false)
  {
      ...
      if ($model->load($this->request->post())) {
        ...
        if ($model->save()) {
          ...
          if ($d) {
            ...
            return ['ok' => true, 'model' => $model, "action" => 'createUserAddress', 'message' => 'User address created successfully'];
          }
    ...
    if ($d) {
      return $this->renderPartial('create', ['model' => $model, 'popup' => $popup, 'd' => $d]);
    }
