...
class RatingController extends Controller
{
   ...
   * @throws NotFoundHttpException if the model cannot be found
   */
  public function actionUpdate($id, $d = false)
  {
    $model = $this->findModel($id);
    ...
    if (
      ...
      if ($d) {
        return $this->redirect(["/shop/product", "id" => $model->product_id]);
      }
    ...
    if ($d) {
      return $this->renderPartial(
        "@app/components/product/_product_detail_section__rating_form",
        ["review_model" => $model]
      );
    }
