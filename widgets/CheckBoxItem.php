...
class CheckBoxItem extends BaseWidget
{
  public $label;
  public $description;
  public $name;
  ...
  public function run()
  {
    ...
    return <<<HTML
            <div class="position-relative">
                <input class="form-check-input position-absolute z-1 ms-3" style="z-index: 1; right: 10px; top: 10px; {$visibilityStyle}" value="{$this->value}" type="checkbox" name="{$this->name}" id="{$this->id}" {$checkedAttribute}>
